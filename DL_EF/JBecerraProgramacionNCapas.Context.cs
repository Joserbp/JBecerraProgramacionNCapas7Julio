...
namespace DL_EF
{
    ...
    public partial class JBecerraProgramacionNCapasJulioEntities : DbContext
    {
        public JBecerraProgramacionNCapasJulioEntities()
            : base("name=JBecerraProgramacionNCapasJulioEntities")
        {
        }
        ...
        public virtual int AlumnoAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string email, string fechaNacimiento, Nullable<int> idSemestre)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, emailParameter, fechaNacimientoParameter, idSemestreParameter);
        }
